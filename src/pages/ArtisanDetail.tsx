    ...
    <div className="py-4 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-10">
        ...
        <div>
            ...
            <div className="flex-1 w-full">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex gap-2">
                  <button
                    className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all ${isFav ? "text-red-500 border-red-200 bg-red-50" : "text-ink-soft border-border hover:bg-bg-sunken"} hover:scale-105`}
                  >
          ...
          {activeTab === "reviews" && (
            <div className="bg-bg-elevated border border-border rounded-3xl p-8 text-center shadow-sm">
